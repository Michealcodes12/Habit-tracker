...
describe('calculateCurrentStreak', () => {
  ...
  it('returns the correct streak for consecutive completed days', () => {
    expect(calculateCurrentStreak(['2023-10-10', '2023-10-09', '2023-10-08'], '2023-10-10')).toBe(3);
  });

  it('ignores duplicate completion dates', () => {
    expect(calculateCurrentStreak(['2023-10-10', '2023-10-10', '2023-10-09'], '2023-10-10')).toBe(2);
  });
